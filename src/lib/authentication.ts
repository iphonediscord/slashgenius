...
const initialiseEnvironment = () => {
    ...
    if (process.env.CLIENT_ID === undefined || process.env.CLIENT_SECRET === undefined || process.env.DB_URI === undefined || process.env.APP_ID === undefined) {
...
export { initialiseEnvironment, getBearerToken, PUBLIC_KEY, CLIENT_ID, CLIENT_SECRET, DB_URI, APP_ID }
